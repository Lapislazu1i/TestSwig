function(BuildPythonLibrary LibraryName)
    file(GLOB SWIG_PYTHON_SRCS "${CMAKE_CURRENT_SOURCE_DIR}/swig_python/*.cxx")
    ...
    copy "${CMAKE_CURRENT_SOURCE_DIR}/interface/interface.i" "${CMAKE_CURRENT_SOURCE_DIR}/swig_python")

    add_custom_command(TARGET ${LibraryName} PRE_BUILD

    COMMAND swig -c++ -python -outdir "${CMAKE_CURRENT_SOURCE_DIR}/swig_python" "${CMAKE_CURRENT_SOURCE_DIR}/swig_python/interface.i")

    add_custom_command(TARGET ${LibraryName} POST_BUILD
    
    COMMAND ${CMAKE_COMMAND} -E
    
    copy $<TARGET_FILE:${LibraryName}> "${CMAKE_CURRENT_SOURCE_DIR}/swig_python")
